...
#. \ `tutorial-apps <https://github.com/Macchinetta/tutorial-apps/tree/1.11.0.RELEASE>`_\ にアクセスする。
...
.. code-block:: java
  ...
  public class GoodsController {
      ...
      public String addToCart(@Validated GoodAddForm form, BindingResult result,
          ...
          if (result.hasErrors()) {
              ResultMessages messages = ResultMessages.error().add("e.xx.yy.5001");
              attributes.addFlashAttribute(messages);
              return "redirect:/goods";
          }
