...
version 1.7.0.SP1.RELEASEで利用するOSSの一覧を以下に示す。
...
.. note::
  ...
  version 1.7.0.SP1.RELEASEでは TERASOLUNA Server Framework for Java 5.6.0.SP1.RELEASE の共通ライブラリを使用している。
