...
`Lombok <https://projectlombok.org/>`_ は、
...
STS以外のIDEを使用する場合は、 `こちらのページ <https://projectlombok.org/download>`_ を参考にされたい。
...
Lombokの「 `Demo Video <https://projectlombok.org/>`_ 」を参照するとよい。
