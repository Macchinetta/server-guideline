...
.. list-table::
   ...
   * - 相関項目チェック
     ...
     - | \ `org.springframework.validation.Validator <https://docs.spring.io/spring-framework/docs/6.0.3/reference/html/core.html#validator>`_\ インタフェースを実装したValidationクラス
       | または Bean Validation
...
#. | \ ``org.springframework.context.MessageSource``\ に定義されているメッセージの中に、ルールに合致するものがあればそれをエラーメッセージとして使用する (Springのルール)。
   | Springのデフォルトのルールについては、「\ `DefaultMessageCodesResolverのJavaDoc <https://docs.spring.io/spring-framework/docs/6.0.3/javadoc-api/org/springframework/validation/DefaultMessageCodesResolver.html>`_\ 」を参照されたい。
...
.. tip::
    ...
    Hibernate Validator 8.xでは、Expression Language 5.0以上をサポートしている。
...
| となる。
| 仕様の詳細については\ `SpringValidatorAdapterのJavaDoc <https://docs.spring.io/spring-framework/docs/6.0.3/javadoc-api/org/springframework/validation/beanvalidation/SpringValidatorAdapter.html#getArgumentsForConstraint(java.lang.String,java.lang.String,jakarta.validation.metadata.ConstraintDescriptor)>`_\ を参照されたい。
...
.. note::
  ...
  application-messages.propertiesのメッセージキーの形式は\ `これ以外にも用意されている <https://docs.spring.io/spring-framework/docs/6.0.3/javadoc-api/org/springframework/validation/DefaultMessageCodesResolver.html>`_\ が、デフォルトメッセージを一部上書きする目的で使用するのであれば、基本的に、\ ``アノテーション名.フォーム属性名.プロパティ名``\ 形式でよい。
...
* アノテーション
  ...
  .. code-block:: java
    ...
    import jakarta.validation.Constraint;
    import jakarta.validation.Payload;
    import jp.co.ntt.fw.spring.functionaltest.domain.cmmn.validation.IPv4Validator;
...
| 対応する言語については \ `org/hibernate/validator <https://github.com/hibernate/hibernate-validator/tree/8.0.0.Final/engine/src/main/resources/org/hibernate/validator>`_\ を参照されたい。
...
.. tip::
  ...
  メッセージキーのルールの詳細は、\ `DefaultMessageCodesResolverのJavadoc <https://docs.spring.io/spring-framework/docs/6.0.3/javadoc-api/org/springframework/validation/DefaultMessageCodesResolver.html>`_\ を参照されたい。
