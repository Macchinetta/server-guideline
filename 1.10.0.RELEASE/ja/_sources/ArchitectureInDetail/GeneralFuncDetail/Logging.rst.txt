...
.. list-table::
  ...
  * - | (5)
    - | 国際化を考慮し\ ``setBasenames``\ メソッドを使用してプロパティファイルを指定する。
      | \ ``setBasenames``\ の詳細は\ ``ResourceBundleMessageSource``\ が継承する\ ``AbstractResourceBasedMessageSource``\ クラスの\ `JavaDoc <https://docs.spring.io/spring-framework/docs/6.1.3/javadoc-api/org/springframework/context/support/AbstractResourceBasedMessageSource.html#setBasenames-java.lang.String...->`_\を参照されたい。
  * - | (6)
    ...
    - \ **ApplicationContextConfig.java**\
      ...
      .. code-block:: java
        ...
        public ExceptionLogger exceptionLogger(
            ...
            bean.setLogMessageFormat("[{0}], {1}"); // (1)
...
.. code-block:: xml
  ...
  date:2013-09-06 23:05:22  thread:tomcat-http--3   USER:anonymousUser  X-Track:97988cc077f94f9d9d435f6f76027428    level:INFO  logger:c.examples.logging.app.welcome.HomeController  message:Welcome home! The client locale is ja.
        ...
        - \ ``SpringSecurityConfig.java``\ 
          ...
          .. list-table::
            ...
            * - 項番
              - 説明
            * - | (1)
              - | Bean定義した\ ``UserIdMDCPutFilter``\ を"AnonymousAuthenticationFilter"の後に追加する。
            * - | (2)
              - | \ ``UserIdMDCPutFilter``\ を定義する。
      
        blankプロジェクトでは\ ``UserIdMDCPutFilter``\ をSpringSecurityConfig.javaに定義している。
...
.. tabs::
  .. group-tab:: Java Config
    ...
    SpringMvcConfig.javaの\ ``addInterceptors``\ 内に以下のように\ ``TraceLoggingInterceptor``\ を追加する。
    ...
    .. code-block:: java
      ...
      public class SpringMvcConfig implements WebMvcConfigurer {
          ...
          public TraceLoggingInterceptor traceLoggingInterceptor() {
              ...
              bean.setWarnHandlingNanos(TimeUnit.SECONDS.toNanos(10L));
              return bean;
          }
    ...
    .. code-block:: xml
      ...
      <mvc:interceptors>
          ...
          <mvc:interceptor>
              ...
              <bean
                  class="org.terasoluna.gfw.web.logging.TraceLoggingInterceptor">
                  <property name="warnHandlingNanos" value="#{T(java.util.concurrent.TimeUnit).SECONDS.toNanos(10L)}" />
              </bean>
          </mvc:interceptor>
          <!-- omitted -->
      </mvc:interceptors>
