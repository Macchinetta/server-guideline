...
.. tip::
    ...
    マルチプロジェクト構成の例として、\ `サンプルアプリケーション <https://github.com/terasolunaorg/terasoluna-tourreservation-mybatis3/tree/5.7.0.SP1.RELEASE>`_\ や\ `共通ライブラリのテストアプリケーション <https://github.com/terasolunaorg/terasoluna-gfw-functionaltest/tree/5.7.0.SP1.RELEASE>`_\ を参照されたい。
