...
テスト用のDIコンテナとして
\ `Spring TestのDI機能 <https://docs.spring.io/spring-framework/docs/5.3.24/reference/html/testing.html#testing-fixture-di>`_\を使用する。

MVCフレームワーク
""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""

テスト用のMVCフレームワークとして
\ `Spring MVC Test Framework <https://docs.spring.io/spring-framework/docs/5.3.24/reference/html/testing.html#spring-mvc-test-framework>`_\を使用する。
...
テスト用のトランザクション管理として
\ `Spring Testのトランザクション管理機能 <https://docs.spring.io/spring-framework/docs/5.3.24/reference/html/testing.html#testing-tx>`_\を使用する。
...
* \ `Spring Test <https://docs.spring.io/spring-framework/docs/5.3.24/reference/html/testing.html#testing-introduction>`_\
...
.. list-table::
    ...
    * - RDBMS
      - `PostgreSQL <https://www.postgresql.org/docs/13/sql-insert.html>`_ 14.6
